...
// import I18nReg from './i18nReg'
// import Router from '@/router'
// import querystring from 'querystring'
import { Notification } from 'element-ui';
import Nprogress from 'nprogress'
import { setApiEncrypt } from './setApiEncrypt'
import { CancelRepeatRequest, RequestInterceptor, ResponseInterceptor } from 'bt-tools'
...
export default function (app,store) {
  ...
  * localStorage统一使用bt-tools的StorageCache，含过期时间控制，参考文档：https://lqs5858.github.io/bt-tools/bt-tools/1.2.4/
     */
    let token = StorageCache.get('token')
    if (token) {
